...
const NavBar = () => {
  ...
  return (
    <header className='bg-palette-5 flex flex-row gap-1 p-5 md:gap-8 md:p-8 items-center justify-around'>
      <Link
        href='/'
        className={`text-palette-3 text-center font-bold md:text-xl px-3 py-1 relative z-10 transition-colors duration-300 before:absolute before:bottom-0 before:left-0 before:right-0 before:top-0 before:-z-10 before:h-full ${
